...
namespace ServiceWebsite.AcceptanceTests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("Representative views Please Contact Us page")]
    public partial class RepresentativeViewsPleaseContactUsPageFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "PleaseContactUs.feature"
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Representative participant does not have access to a laptop or desktop")]
        [NUnit.Framework.CategoryAttribute("smoketest")]
        [NUnit.Framework.CategoryAttribute("VIH-4563")]
        public virtual void RepresentativeParticipantDoesNotHaveAccessToALaptopOrDesktop()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Representative participant does not have access to a laptop or desktop", null, new string[] {
                        "smoketest",
                        "VIH-4563"});
#line 7
