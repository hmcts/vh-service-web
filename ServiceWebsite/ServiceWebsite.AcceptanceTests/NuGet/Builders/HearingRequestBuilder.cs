...
namespace ServiceWebsite.AcceptanceTests.NuGet.Builders
{
    internal class HearingRequestBuilder
    {
        ...
        private string _caseTypeName = "Civil Money Claims";
        ...
        public HearingRequestBuilder WithContext(ITestContext context)
        {
            _context = context;
            return this;
        }
        ...
        public HearingRequestBuilder WithCaseTypeName(string caseTypeName)
        {
            _caseTypeName = caseTypeName;
            return this;
        }
        ...
        public BookNewHearingRequest Build()
        {
            ...
            cases[0].Name = $"Service Web Automated Test {GenerateRandom.Letters(_fromRandomNumber)}";
            cases[0].Number = $"{GenerateRandom.CaseNumber(_fromRandomNumber)}";

            _request = Builder<BookNewHearingRequest>.CreateNew()
                .With(x => x.Case_type_name = _caseTypeName)
                ...
                .With(x => x.Created_by = _context.GetCaseAdminUsers().First().Username)
                .Build();
