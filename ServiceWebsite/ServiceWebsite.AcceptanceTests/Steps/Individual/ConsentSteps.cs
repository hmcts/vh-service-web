...
namespace ServiceWebsite.AcceptanceTests.Steps.Individual
{
    ...
    public class ConsentSteps : ISteps
    {
        ...
        {
            _browsers[_c.CurrentUser.Key].Driver.WaitUntilElementExists(CommonLocators.RadioButtonWithLabel(_c.ServiceWebConfig.TestConfig.TestData.Consent)).Click();
            ...
            {
                Answer = _c.ServiceWebConfig.TestConfig.TestData.Consent,
                ExtendedAnswer = null,
                QuestionKey = IndividualQuestionKeys.ConsentQuestion
            });
        }
    }
}
