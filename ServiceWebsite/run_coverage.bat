...
SET exclude=\"[ServiceWebsite.BookingApi.Client]*,[ServiceWebsite.UserAPI.Client]*,[*]ServiceWebsite.Swagger.*,[ServiceWebsite]ServiceWebsite.Program,[ServiceWebsite]ServiceWebsite.Startup,[ServiceWebsite]ServiceWebsite.ConfigureServiceExtensions,[ServiceWebsite.IntegrationTests]*,[ServiceWebsite.UnitTests]*\"
