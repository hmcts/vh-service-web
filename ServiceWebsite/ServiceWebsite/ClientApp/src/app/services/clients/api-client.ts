...
export class ApiClient {
     ...
     * @return Success
     */
    updateSuitabilityAnswers(hearingId: string, answers: HearingSuitabilityAnswer[] | null | undefined): Observable<string> {
    ...
    protected processUpdateSuitabilityAnswers(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
