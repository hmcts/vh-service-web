...
export class ApiClient {
    ...
    getCurrentParticipant(): Observable<ParticipantResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<ParticipantResponse>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetCurrentParticipant(response: HttpResponseBase): Observable<ParticipantResponse> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ParticipantResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 404) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ParticipantResponse>(<any>null);
    }
...
export class ServiceWebApiException extends Error {
    message: string;
    status: number; 
    response: string; 
    ...
    protected isServiceWebApiException = true;

    static isServiceWebApiException(obj: any): obj is ServiceWebApiException {
        return obj.isServiceWebApiException === true;
    }
}
...
function throwException(message: string, status: number, response: string, headers: { [key: string]: any; }, result?: any): Observable<any> {
    if(result !== null && result !== undefined)
        ...
        return _observableThrow(new ServiceWebApiException(message, status, response, headers, null));
}
