...
import { ParticipantSuitabilityModel, SelfTestAnswers } from './modules/base-journey/participant-suitability.model';
import { CheckYourComputerComponent } from './modules/self-test-journey/pages/check-your-computer/check-your-computer.component';
import { SelfTestJourneySteps } from './modules/self-test-journey/self-test-journey-steps';
...
describe('CheckYourComputerComponent', () => {
    ...
    it(`should submit and go to ${SelfTestJourneySteps.SwitchOnCameraAndMicrophone} if answering yes and device type is mobile with mobile support is enabled`, async () => {
        ...
        component.choice.setValue(true);
        await component.submit();
        expect(component.mobileSupportEnabled).toBe(true);
