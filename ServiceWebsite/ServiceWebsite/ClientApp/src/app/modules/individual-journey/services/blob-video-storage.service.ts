...
export class BlobVideoStorageService extends VideoUrlService {
  ...
  readonly lowResolutions = new Map<VideoFiles, string>([
    ...
    [VideoFiles.BeforeTheDay_JudgeView_Participant, 'btd_judgeview_individual_small.mp4'],
  ]);
  ...
  readonly highResolutions = new Map<VideoFiles, string>([
    ...
    [VideoFiles.BeforeTheDay_JudgeView_Participant, 'btd_judgeview_individual_large.mp4'],
  ]);
