...
const configureTestBedFor = <T extends SuitabilityChoiceTextboxPageBaseComponent<T>>
...
const cannotProceedUntilChoiceIsSelected =
  <T extends SuitabilityChoiceTextboxPageBaseComponent<T>>(component: Type<T>, customiseConfiguration?: Function):
