...
//import { ActivatedRouteMock } from '../../../../testing/mocks/mock-activated-route';
...
//  // const component = new PresentingTheCaseComponent(journey, new ActivatedRouteMock());
...
describe('PresentingTheCaseComponent', () => {
  ...
  it(`should go to ${RepresentativeJourneySteps.CheckYourAnswers} on continuing when mode is Edit`, () => {
    ...
    component = componentFixture.componentInstance;
    fixture = new SuitabilityChoiceComponentFixture(componentFixture);
   // componentFixture.Providers.
   //   componentFixture.Providers.overrideProvider(ActivatedRoute, { useValue: { queryParams: from([{ mode: 'Edit' }]) } } );
    fixture.detectChanges();
    fixture.radioBoxIsClicked('#i-will-be-presenting');
