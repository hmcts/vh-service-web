...
describe('RepresentativeGuard', () => {
    ...
    it('should not be able to activate component if role is Individual', waitForAsync(async () => {
    ...
    it('should be able to activate component if role is Representative', waitForAsync(async () => {
        const profile = new UserProfile();
