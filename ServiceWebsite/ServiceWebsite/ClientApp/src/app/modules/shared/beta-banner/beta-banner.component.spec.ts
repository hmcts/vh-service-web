...
const routes = [{ path: 'sub-component1', component: Mock1Component }, { path: 'sub-component2', component: Mock2Component }];
...
describe('BetaBannerComponent', () => {
    ...
    it(
        'navigate to sub-component1 should see sub-component1 in router url',
        fakeAsync(() => {
            fixture.ngZone.run(() => {
